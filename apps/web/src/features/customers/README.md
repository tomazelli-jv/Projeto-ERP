...
A apresentação agora é compartilhada com Fornecedores em features/parties. As rotas de Clientes, a chave de persistência e o contrato do repository permanecem iguais.
