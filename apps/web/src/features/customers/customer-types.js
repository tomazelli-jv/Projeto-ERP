 ...
 * @typedef {{type:CustomerType,status:CustomerStatus,name:string,legalName:string,tradeName:string,document:string,birthDate:string,stateRegistration:string,municipalRegistration:string,contactName:string,email:string,phone:string,mobile:string,address:CustomerAddress,notes:string}} CreateCustomerInput
